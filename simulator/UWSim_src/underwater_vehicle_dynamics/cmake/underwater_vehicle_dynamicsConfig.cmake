...
if("FALSE" STREQUAL "TRUE")
  set(underwater_vehicle_dynamics_SOURCE_PREFIX /home/ponti/catkin_ws/src/underwater_simulation/underwater_vehicle_dynamics)
  set(underwater_vehicle_dynamics_DEVEL_PREFIX /home/ponti/catkin_ws/devel_isolated/underwater_vehicle_dynamics)
  ...
  set(underwater_vehicle_dynamics_INSTALL_PREFIX /home/ponti/catkin_ws/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'underwater_vehicle_dynamics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'underwater_vehicle_dynamics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT underwater_vehicle_dynamics_NUM_DUMMY_TARGETS)
      set(underwater_vehicle_dynamics_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::underwater_vehicle_dynamics::wrapped-linker-option${underwater_vehicle_dynamics_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR underwater_vehicle_dynamics_NUM_DUMMY_TARGETS "${underwater_vehicle_dynamics_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::underwater_vehicle_dynamics::wrapped-linker-option${underwater_vehicle_dynamics_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND underwater_vehicle_dynamics_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ponti/catkin_ws/install_isolated/lib;/home/ponti/catkin_ws/install_isolated/lib;/opt/ros/melodic/lib)
